...
using MusicHub.STS.Identity.Configuration;
using MusicHub.STS.Identity.Configuration.ApplicationParts;
using MusicHub.STS.Identity.Configuration.Constants;
using MusicHub.STS.Identity.Configuration.Interfaces;
using MusicHub.STS.Identity.Helpers.Localization;

namespace MusicHub.STS.Identity.Helpers
{
